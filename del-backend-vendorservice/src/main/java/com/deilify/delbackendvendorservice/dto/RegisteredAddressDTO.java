...
public class RegisteredAddressDTO {
	...
	public RegisteredAddressDTO(Integer registeredAddressId, Integer vendorEntityId, String addressLine1,
	...
	public RegisteredAddressDTO() {
		super();
	}

	@Override
	public String toString() {
		return "RegisteredAddressDTO [registeredAddressId=" + registeredAddressId + ", vendorEntityId=" + vendorEntityId
