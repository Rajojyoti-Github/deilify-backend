...
public class StoreAddressDto {
	...
	public StoreAddressDto(Integer storeAddressId, Integer vendorEntityId, String addressLine1, String addressLine2,
			String city, String state, String district, String pin, String country) {
		super();
		this.storeAddressId = storeAddressId;
		this.vendorEntityId = vendorEntityId;
		this.addressLine1 = addressLine1;
	...
	public String toString() {
		return "StoreAddressDto [storeAddressId=" + storeAddressId + ", vendorEntityId=" + vendorEntityId
