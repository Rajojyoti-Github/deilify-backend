...
@Entity
@Table(name = "Vendorregisteredaddressenitity")
public class VendorRegisteredAddressEnitity {
		...
		public VendorRegisteredAddressEnitity(Integer registeredAddressId, Integer vendorEntityId, String addressLine1,
		...
		public VendorRegisteredAddressEnitity() {
			super();
		}

		@Override
		public String toString() {
			return "VendorregisteredAddressEnitity [registeredAddressId=" + registeredAddressId + ", vendorEntityId="
